            ...
            <div className="row d-flex mt-0">
                ...
                <div className="p-4" style={{ width: 'calc(100% - 80px)', padding: '10px' }}>
                    ...
                    <div className='row mt-2'>
                        <p className='fw-bold' style={{ fontFamily: 'Poppins, sans-serif' }}>ResNet Family</p>
                        <p style={{ fontFamily: 'Poppins, sans-serif' }}>Deep Residual Learning for Image Recognition</p>
                        <hr style={{ width: "40%" }} />
                    </div>
